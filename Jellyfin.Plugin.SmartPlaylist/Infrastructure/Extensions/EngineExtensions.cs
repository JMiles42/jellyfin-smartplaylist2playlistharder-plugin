...
internal static class EngineExtensions
{
	...
	public static bool StringArrayContainsSubstring(this IReadOnlyCollection<string> left,
													string                           right,
													StringComparison                 stringComparison) =>
			left.Any(a => a.Contains(right, stringComparison));

	public static bool StringArrayContains(this IReadOnlyCollection<string> left,
										   string                           right,
										   StringComparison                 stringComparison) =>
