...
public record EngineOperatorResult(string Name, EngineOperatorResultKind Kind)
{
    ...
    public static EngineOperatorResult NotAValidFor() => new(nameof(NotAValidFor), EngineOperatorResultKind.NotAValidOperatorFor);
    public static EngineOperatorResult NotAValidFor(string message) => new($"{nameof(NotAValidFor)}: {message}", EngineOperatorResultKind.NotAValidOperatorFor);
    public static EngineOperatorResult NotAValidFor(object message) => new($"{nameof(NotAValidFor)}: {message}", EngineOperatorResultKind.NotAValidOperatorFor);
...
public record MultipleEngineOperatorResult : EngineOperatorResult
{
    ...
    public MultipleEngineOperatorResult(params EngineOperatorResult[] errors) : base(string.Empty, EngineOperatorResultKind.Error)
    {
