...
public readonly struct SortableBaseItem
{
	...
	public SortableBaseItem(BaseItem baseItem) => BaseItem = baseItem;
	...
	public double DaysSincePremiereDate =>
			BaseItem.PremiereDate.HasValue? (DateTime.UtcNow - BaseItem.PremiereDate.Value).TotalDays : 0;
