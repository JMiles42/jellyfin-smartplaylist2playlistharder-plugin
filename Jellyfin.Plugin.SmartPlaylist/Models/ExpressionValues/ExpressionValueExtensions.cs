...
public static class ExpressionValueExtensions
{
	...
	public static ExpressionValue ToExpressionValue(this IReadOnlyList<DateTime> value) => ExpressionValue.Create(value);
	public static ExpressionValue ToExpressionValue(this IReadOnlyList<DateOnly> value) => ExpressionValue.Create(value);
	public static ExpressionValue ToExpressionValue(this IReadOnlyList<TimeOnly> value) => ExpressionValue.Create(value);
	public static ExpressionValue ToExpressionValue(this IReadOnlyList<TimeSpan> value) => ExpressionValue.Create(value);
}
